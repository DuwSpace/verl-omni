...
GROUP_PATTERNS = {
    ...
    "ci-e2e-omni": (
        ...
        "tests/special_e2e/*qwen3_omni*",
        "tests/special_e2e/*omni_preference*",
    ...
    "ci-e2e-diffusion": (
        ...
        "tests/special_e2e/run_omnift_ltx2_tiny.sh",
        "tests/special_e2e/build_ltx2_omnift_tiny_random.py",
        "tests/special_e2e/omnift_dummy_reward.py",
        "verl_omni/pipelines/**",
