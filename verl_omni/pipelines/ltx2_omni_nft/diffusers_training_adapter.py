...
from verl_omni.pipelines.ltx2_flow_grpo.common import apply_x0_cfg
...
class LTX23OmniNFT(LTX23FlowGRPO):
    ...
    def _build_joint_model_inputs(
        *,
        ...
        """Build OmniNFT's native LTX joint audio-video transformer inputs."""
        common = {
