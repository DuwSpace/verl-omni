...
from .native_reward import activate_reward_model, deactivate_reward_model
...
def activate(state: _VideoAlignNativeState, device: int | str | torch.device) -> None:
    ...
    activate_reward_model(state, device, reward_name="VideoAlign Native Reward")
