...
async def compute_score_batch(batch, reward_model, *, micro_batch_size: int, **kwargs) -> dict[str, Any]:
    ...
    return {
        ...
        "metrics": {
            ...
            "base_model_revision": _DEFAULT_BASE_MODEL_REVISION,
        },
...
class VideoAlignNativeModel:
    """Raw VideoAlign inference adapter owned by the upstream native executor."""
    ...
    def offload_to_cpu(self) -> None:
        """Retain the loaded model while releasing accelerator parameters."""
